...
const Footer = () => {
  return (
    <footer className="w-full sm:flex sm:items-center sm:justify-center h-10 sm:p-6 xl:p-8 bg-gradient-to-b from-slate-800 via-sky-700 to-cyan-900 antialiased gap-8">
