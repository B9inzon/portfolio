...
const Contact = () => {
  return (
    <div className="flex flex-col bg-[#061e24] bg-opacity-100 justify-between w-full min-h-full pt-24">
      <section id="Contact" className="w-full items-center justify-center text-center h-auto">
        <h1 className="text-[#b7c9cd] text-6xl font-thin mb-8">Contacto</h1>
        <p className="text-[#b7c9cd] text-2xl font-thin mb-12">Contáctame para dar vida a tus ideas o simplemente para saludarme.</p>
